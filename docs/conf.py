# -*- coding: utf-8 -*-
#
# puppet-diamond documentation build configuration file, created by
...
project = u'Puppet-Diamond Documentation'
...
htmlhelp_basename = 'puppet_diamond_doc'
...
latex_documents = [
    ('index', 'puppet-diamond.tex', u'puppet-diamond Documentation',
...
man_pages = [
    ('index', 'puppet-diamond', u'puppet-diamond Documentation',
...
texinfo_documents = [
    ('index', 'puppet-diamond', u'puppet-diamond Documentation',
    u'Ian Dennis Miller', 'puppet-diamond', 'One line description of project.',
    'Miscellaneous'),
]
